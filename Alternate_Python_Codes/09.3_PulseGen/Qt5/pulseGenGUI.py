...
class Ui(QtWidgets.QMainWindow):
    ...
    def __init__(self):
        ...
        uic.loadUi('pulseGen.ui', self)
        self.pulse_gen_display = PulseGenDisplay()
        self.display_data = [0]*500
        
        self.generator_screen = self.findChild(
            QtChart.QChartView,'generator_screen')

        self.pulse_height_dial = self.findChild(
            QtWidgets.QDial,'pulse_height_dial')
        ...
        self.pulse_height_text = self.findChild(
            QtWidgets.QLineEdit,'pulse_height_text')
        ...
        # pulse shape
        self.pulse_shape_combo = self.findChild(
            QtWidgets.QComboBox,'pulse_shape_combo')
        ...
        self.gen_freq_combo = self.findChild(
            QtWidgets.QComboBox,'gen_freq_combo')
        ...
        self.display_freq_combo = self.findChild(
            QtWidgets.QComboBox,'display_freq_combo')
        ...
        self.start_stop_pb = self.findChild(
            QtWidgets.QPushButton,'start_stop_pb')
